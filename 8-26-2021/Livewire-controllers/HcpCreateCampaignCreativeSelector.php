...
class HcpCreateCampaignCreativeSelector extends Component
{
    ...
    public function create(Request $request, DfaReader $reader)
    {
        ...
        DB::table('teams')->where('id', Auth::user()->current_team_id)->update(['dfa_campaigns_created' => 1]);
