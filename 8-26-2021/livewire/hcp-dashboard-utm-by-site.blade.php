<div>
    <h2 class="text-evoke text-xl font-medium tracking-wide">UTM By Media Partner</h2>
    <div class="mt-3 ">
                    ...
                    <table class="w-full divide-y divide-gray-200">
                        ...
                        @foreach($sites as $site)
                            ...
                            @else
                                <tr class="bg-gray-50">
                                    ...
                                    <td class="px-2 py-1 whitespace-nowrap text-sm text-gray-500">
                                        {{ $site['unique_click_reach'] }}
                                    </td>
                                    <td class="px-2 py-1 whitespace-nowrap text-sm text-gray-500">
                                        {{ $site['unique_impression_reach'] }}
                                    </td>
                                    <td class="px-2 py-1 whitespace-nowrap text-sm text-gray-500">
                                        {{ $site['unique_avg_impression_freq'] }}
                                    </td>
                                    <td class="px-2 py-1 whitespace-nowrap text-sm text-gray-500">
                                        {{ $site['unique_total_reach'] }}
                                    </td>
                                </tr>
                                @endforeach
                        </tbody>
                        <tfoot>
                            <tr class="hidden" wire:loading.class.remove="hidden" >
                                <td colspan="6" class=" align-middle text-center items-center">
