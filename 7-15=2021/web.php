...
Route::get('/media-partners',[\App\Http\Controllers\MediaPartnerController::class, 'index'])->name('media-partners.index');

Route::get('/media-partners/create',[\App\Http\Controllers\MediaPartnerController::class, 'create'])->name('media-partners.create');

Route::post('/save',[\App\Http\Controllers\MediaPartnerController::class, 'save'])->name('save');
