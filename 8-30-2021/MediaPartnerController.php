...
use App\Jobs\ImportMediaPartnerULD;
...
class MediaPartnerController extends Controller
{
    ...
    */
    ...
    public function processUpload(Request $request)
    {
        ...
        // Job call here.
        ImportMediaPartnerULD::dispatch($selected_values, $file_has_column_header, $request->csv_data_file_id, Auth::user()->id);
        return redirect('/media-partners')->with('success', 'Import has been queued. You will recieve an email when it complete.');
