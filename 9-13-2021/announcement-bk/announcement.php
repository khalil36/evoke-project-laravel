...
class AnnouncementPlugin{
    ...
    function CreatePages(){
        ...
        //add_menu_page( 'Plugin Page', 'Announcement', 'manage_options', 'Announcement', array( __CLASS__, 'admin_page' ), 'dashicons-bell');
    ...
    function admin_page(){
        include_once plugin_dir_path( __FILE__ ) . 'pages/announcement-form.php';
    }
