            ...
            try {
                ...
                if ($status === 'REPORT_AVAILABLE') {
                    ...
                    foreach ($data as $d) {
                        ...
                        $unique_keys = ['team_id', 'npi', 'site', 'placement', 'activity', 'date'];

                        FloodLightActivity::upsert($row_data, $unique_keys);

                  }
                    $user->notify(new testEmail('Place 1', 'REPORT_AVAILABLE'));
                    ...
                    $user->notify(new testEmail('Place 2', 'PROCESSING'));
                    ...
                    $user->notify(new testEmail('Place 3', ' else PROCESSING'));
                }
