...
class CD_Announcement_Plugin{
    ...
    if( function_exists('acf_add_local_field_group') ):
        ...
        //         'hide_on_screen' => '',
        //         'active' => 1,
        //         'description' => '<p>NOTE: Please clear wpengin cache after making changes.</p>',
        //         ));
    ...
    {
        // echo '---- : '.current(get_field('enable_announcement_bar', 'option'));
        // echo '<pre>'. print_r(get_field('enable_announcement_bar', 'option'));

        // if  (   ( get_field('start_date', 'option') && time() >= strtotime(str_replace('/', '-', get_field('start_date', 'option'))) ) && 
        //         ( !get_field('end_date', 'option') || time() < strtotime(str_replace('/', '-', get_field('end_date', 'option'))) )
        //     )
