 ...
 public function test(){
    ...
    ->map(function (array $row) {
      return [
        ...
        // 'first_name' => 'bbb',
        // 'last_name' => 'aaa',
        'first_name' => preg_replace('/[\x00-\x1F\x80-\xFF]/', '', $row[18]),
        'last_name' => preg_replace('/[\x00-\x1F\x80-\xFF]/', '', $row[19]),
    ...
    echo '<b>Total Execution Time:</b> '.($execution_time*1000)/60000;
