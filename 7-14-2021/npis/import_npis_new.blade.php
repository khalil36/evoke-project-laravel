							  ...
							  <fieldset>
							    ...
							    <div class="space-y-4">
							      <label class="relative block rounded-lg border border-gray-300 bg-white shadow-sm px-6 py-4 cursor-pointer hover:border-gray-400 sm:flex sm:justify-between focus-within:ring-1 focus-within:ring-offset-2 focus-within:ring-indigo-500">
							        <input type="radio" name="import_option" value="merge" class="sr-only" aria-labelledby="import_option-0-label" aria-describedby="import_option-0-description-0 import_option-0-description-1">
							        <div class="flex items-center">
							          <div class="text-sm">
							            <p id="import_option-0-label" class="text-sm text-gray-600 font-semibold">
							              Merge
							            </p>
							            <div id="import_option-0-description-0" class="text-gray-500">
							              <p class="sm:inline">Merge with Existing Data?</p>
							            </div>
							          </div>
							        </div>
							      ...
							      <label class="relative block rounded-lg border border-gray-300 bg-white shadow-sm px-6 py-4 cursor-pointer hover:border-gray-400 sm:flex sm:justify-between focus-within:ring-1 focus-within:ring-offset-2 focus-within:ring-indigo-500">
							        <input type="radio" name="import_option" value="overwrite" class="sr-only" aria-labelledby="import_option-1-label" aria-describedby="import_option-1-description-0 import_option-1-description-1">
							        <div class="flex items-center">
							          <div class="text-sm">
							            <p id="import_option-1-label" class="text-sm text-gray-600 font-semibold">
							              Overwrite
							            </p>
							            <div id="import_option-1-description-0" class="text-gray-500">
							              <p class="sm:inline">Overwrite Existing Data?</p>
							            </div>
							          </div>
							        </div>
							        <div class="border-transparent absolute -inset-px rounded-lg border-2 pointer-events-none" aria-hidden="true"></div>
							      ...
							      <label class="relative block rounded-lg border border-gray-300 bg-white shadow-sm px-6 py-4 cursor-pointer hover:border-gray-400 sm:flex sm:justify-between focus-within:ring-1 focus-within:ring-offset-2 focus-within:ring-indigo-500">
							        <input type="radio" name="import_option" value="delete" class="sr-only" aria-labelledby="import_option-2-label" aria-describedby="import_option-2-description-0 import_option-2-description-1">
							        <div class="flex items-center">
							          <div class="text-sm">
							            <p id="import_option-2-label" class="text-sm text-gray-600 font-semibold">
							              Delete
							            </p>
							            <div id="import_option-2-description-0" class="text-gray-500">
							              <p class="sm:inline">Delete Existing Data?</p>
							            </div>
							          </div>
							        </div>
							        <div class="border-transparent absolute -inset-px rounded-lg border-2 pointer-events-none" aria-hidden="true"></div>
