  ...
  <div class="flex">
    ...
    <div class="ml-3">
      ...
      <div class="mt-2 text-sm text-red-700">
        <p>
            <strong>NPI</strong> is a required field.
        </p>
      </div>
    </div>
  </div>
...
<script type="text/javascript">
    ...
    //                     if (objSelect.value == 'first_name') {
    //                         existing_option = 'First Name';
    //                     } else if (objSelect.value == 'last_name') {
    //                         existing_option = 'Last Name';
    //                     } else if (objSelect.value == 'npi') {
    //                         existing_option = 'NPI';
    //                     } else if (objSelect.value == 'email') {
    //                         existing_option = 'Email';
    //                     } else if (objSelect.value == 'decile') {
    //                         existing_option = 'Decile';
    //                     }
