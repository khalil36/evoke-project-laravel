        ...
        <x-jet-dialog-modal wire:model="confirmingNewModel">
           ...
           <x-slot name="content">
            <div class="flex bg-white">
                ...
                <div class="flex-1">
                    <label for="wieght_" class="block text-lg leading-6 font-medium text-gray-900 sm:mt-px sm:pt-2">
                        Weight 1:
                    </label>
                </div>
                    ...
                    <div class="flex items-center">
                        <div x-data="range()" x-init="mintrigger(); maxtrigger()" class="relative max-w-xl w-full">
                            ...
                            <div class="flex justify-between items-center py-5">
                                ...
                                <div>
                                    <input type="text" name="wieght_" maxlength="3" x-on:input="maxtrigger" x-model="maxprice" class="px-3 py-2 border border-gray-200 rounded w-24 text-center">
                                </div>
                            </div>
